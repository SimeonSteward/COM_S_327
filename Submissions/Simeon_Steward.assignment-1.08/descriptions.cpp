...
/*
 *Really can olny be called once it is confirmed that this is the description that you want to use,
 *and then must be put into the dungeon object map
 */
const object object_description::create_object() {
