...
# define TYPE_WEAPON       0x00000001
# define TYPE_OFFHAND      0x00000002
# define TYPE_RANGED       0x00000004
# define TYPE_ARMOR        0x00000008
# define TYPE_HELMET       0x00000010
# define TYPE_CLOAK        0x00000020
# define TYPE_GLOVES       0x00000040
# define TYPE_BOOTS        0x00000080
# define TYPE_RING         0x00000100
# define TYPE_AMULET       0x00000200
# define TYPE_LIGHT        0x00000400
# define TYPE_SCROLL       0x00000800
# define TYPE_BOOK         0x00001000
# define TYPE_FLASK        0x00002000
# define TYPE_GOLD         0x00004000
# define TYPE_AMMUNITION   0x00008000
# define TYPE_FOOD         0x00010000
# define TYPE_WAND         0x00020000
# define TYPE_CONTAINER    0x00040000
# define TYPE_BIT19        0x00080000
# define TYPE_BIT20        0x00100000
# define TYPE_BIT21        0x00200000
# define TYPE_BIT22        0x00400000
# define TYPE_BIT23        0x00800000
# define TYPE_BIT24        0x01000000
# define TYPE_BIT25        0x02000000
# define TYPE_BIT26        0x04000000
# define TYPE_BIT27        0x08000000
# define TYPE_BIT28        0x10000000
# define TYPE_BIT29        0x20000000
# define TYPE_BIT30        0x40000000
# define TYPE_BIT31        0x80000000

# define has_type(object, bit)       \
  ((object)->type & TYPE_##bit)
...
static const struct {
...
} types_lookup[] =
  {
    ...
    * number), so it's much more efficient to do a linear search      *
    * rather than a binary search.  Zeros on the end are sentinals to *
    * stop the search.  notes: 1) Performance isn't a big deal        *
    * here, since this is initialization, not gameplay;               *
    *                             */
   { "WEAPON"    , TYPE_WEAPON     },
...
std::ostream &object_description::print(std::ostream &o)
{
  ...
  for (i = num_types = 0; types_lookup[i].name; i++) {
    if (type & types_lookup[i].value) {
      num_types++;
      o << types_lookup[i].name << " ";
    }
  }
  if (!num_types) {
    o << "Monster failing to live up to full potential";
